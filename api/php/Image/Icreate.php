...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (!isset($data->type) || !isset($data->product_id) || !isset($data->pic_name)) {
        http_response_code(400);
    ...
    $sql = "INSERT INTO images (type, product_id, pic_name) VALUES (?, ?, ?)";
    ...
    $stmt->bind_param('sis', $type, $product_id, $pic_name); // 'sis', hogy a paramok milyen típusúak lesznek string, integer, string
    $result = $stmt->execute();
