...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (!isset($data->name) || !isset($data->sku) || !isset($data->warranty) || !isset($data->discount) || !isset($data->storage) || !isset($data->price)){
        http_response_code(400);
    ...
    $sql = "INSERT INTO ssd (name, sku, warranty, discount, storage,price,discount_price) VALUES (?, ?, ?, ?, ?,?,?)";
