...
export class CreateComponent {
  ...
  save() {
    if(this.form.get('name')?.value != '' && this.form.get('sku')?.value != '' && this.form.get('warranty')?.value != '' && this.form.get('discount')?.value != ''&& this.form.get('storage')?.value != '' && this.form.get('writespeed')?.value != '' && this.form.get('price')?.value != '' && this.form.get('discountprice')?.value != ''){
